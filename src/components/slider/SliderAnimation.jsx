...
const conctInfo = {
  phone: "+54 (9) 11 2265-3586",
  email: "laclaujeanpaul@gmail.com",
};
      ...
      <section id="home" className="home-banner">
        <div className="hb-top-fixed d-flex">
          <div className="hb-info">
            <a href="tel:+54 (9) 11 2265-3586">{conctInfo.phone}</a>
            <a href="mailto:mail%20to:laclaujeanpaul@gmail.com,com">
              {conctInfo.email}
            </a>
          </div>
